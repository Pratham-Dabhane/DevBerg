const COLORS: Record<string, string> = {
  ...
  LlamaIndex: "bg-indigo-400/10 text-indigo-400 border-indigo-400/15",
  Keras: "bg-red-400/10 text-red-400 border-red-400/15",
  MLflow: "bg-cyan-400/10 text-cyan-400 border-cyan-400/15",
  "Stable Diffusion": "bg-fuchsia-400/10 text-fuchsia-400 border-fuchsia-400/15",
  Weaviate: "bg-lime-400/10 text-lime-400 border-lime-400/15",
  Milvus: "bg-blue-400/10 text-blue-400 border-blue-400/15",
  // Backend
  ...
  Gin: "bg-sky-400/10 text-sky-400 border-sky-400/15",
  "Ruby on Rails": "bg-red-500/10 text-red-400 border-red-500/15",
  "ASP.NET Core": "bg-violet-400/10 text-violet-400 border-violet-400/15",
  Hono: "bg-orange-400/10 text-orange-400 border-orange-400/15",
  // Frontend
  ...
  Nuxt: "bg-green-400/10 text-green-400 border-green-400/15",
  Remix: "bg-indigo-400/10 text-indigo-400 border-indigo-400/15",
  Astro: "bg-fuchsia-400/10 text-fuchsia-400 border-fuchsia-400/15",
  SolidJS: "bg-blue-400/10 text-blue-400 border-blue-400/15",
  ...
  Zig: "bg-amber-400/10 text-amber-400 border-amber-400/15",
  ...
  Elasticsearch: "bg-yellow-400/10 text-yellow-400 border-yellow-400/15",
  Supabase: "bg-emerald-400/10 text-emerald-400 border-emerald-400/15",
  Prisma: "bg-teal-400/10 text-teal-400 border-teal-400/15",
  "Drizzle ORM": "bg-lime-400/10 text-lime-400 border-lime-400/15",
  SQLAlchemy: "bg-rose-400/10 text-rose-400 border-rose-400/15",
  DuckDB: "bg-amber-400/10 text-amber-400 border-amber-400/15",
  // DevOps
  ...
  Ansible: "bg-red-400/10 text-red-400 border-red-400/15",
  "GitHub Actions": "bg-stone-400/10 text-stone-300 border-stone-400/15",
  ArgoCD: "bg-orange-400/10 text-orange-400 border-orange-400/15",
  Grafana: "bg-amber-400/10 text-amber-400 border-amber-400/15",
  Prometheus: "bg-rose-400/10 text-rose-400 border-rose-400/15",
  // Runtime / Tools
  ...
  Tauri: "bg-yellow-400/10 text-yellow-400 border-yellow-400/15",
  Electron: "bg-sky-400/10 text-sky-400 border-sky-400/15",
  // Mobile
  Flutter: "bg-sky-400/10 text-sky-400 border-sky-400/15",
  "React Native": "bg-sky-400/10 text-sky-400 border-sky-400/15",
};

// Deterministic color for unknown techs based on name hash
const FALLBACK_PALETTES = [
  ...
  "bg-teal-400/10 text-teal-400 border-teal-400/15",
  "bg-indigo-400/10 text-indigo-400 border-indigo-400/15",
  "bg-lime-400/10 text-lime-400 border-lime-400/15",
  "bg-fuchsia-400/10 text-fuchsia-400 border-fuchsia-400/15",
  "bg-sky-400/10 text-sky-400 border-sky-400/15",
